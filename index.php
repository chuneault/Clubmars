...
<div class="maincontent">
  ...
  <?php
    ...
    $result = mysql_query('select * from events where active = 1 and show_main_page = 1 order by event_date desc;') or die(mysql_error());

    while ($row = mysql_fetch_assoc($result)) {
      echo "<div class=\"mainpanel\">\n";
      echo "  <div class=\"content\">\n";
      echo "	  <h1>" .utf8_encode($row['title'])  ."<label>" .$row['event_date']   ."</label></h1>\n";
